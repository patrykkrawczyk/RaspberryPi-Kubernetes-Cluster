...
# sshpass -p $password scp resources/dashboard.yml $username@${ips[0]}:/home/$username/

# sshpass -p "raspberry" ssh -o StrictHostKeyChecking=no pi@192.168.0.101 sudo kubeadm reset
# sshpass -p "raspberry" ssh -o StrictHostKeyChecking=no pi@192.168.0.102 sudo kubeadm reset
# sshpass -p "raspberry" ssh -o StrictHostKeyChecking=no pi@192.168.0.103 sudo kubeadm reset
